...
// Endpoint 2: Get the hotels sorted by rating
...
// Endpoint 3: Get the hotels sorted by reviews
...
// Endpoint 4: Filter the hotels based on the amenity
app.get('/hotels/filter/amenity', (req, res) => {
  const { amenity } = req.query;
  console.log(`Filtering hotels by amenity: ${amenity}`); // Debugging line

  // Filter hotels based on the amenity field
...
// Endpoint 5: Filter the hotels based on the country
...
// Endpoint 6: Filter the hotels based on the category
